        ...
        install: function (vue) {
            ...
            vue.prototype.$actionsheet = new Vue({
                ...
                template: '<div class="actionSheet_wrap">' +
                               '<div @click="cancel" class="weui_mask_transition" :class="{ \'weui_fade_toggle\':isShow }" :style="{ display: isDispaly ? \'block\':\'none\' }"></div>' +
                               '<section class="weui_actionsheet" @transitionend="transitionend" @webkitTransitionEnd="transitionend" :class="{ \'weui_actionsheet_toggle\':isShow }">' +
                                   '<div class="weui_actionsheet_menu">' +
                                        '<div v-for="menu in menus" class="weui_actionsheet_cell" @click="choose(menu)" v-text="menu.text"></div>' +
                                    '</div>' +
                                    '<div :style="{ display: needCancel?\'block\':\'none\'}" class="weui_actionsheet_action">' +
                                        '<div @click="cancel" class="weui_actionsheet_cell">{{cancelText}}</div>' +
                                    '</div>' +
                               '</section>' +
                            '</div>',
                methods: {
